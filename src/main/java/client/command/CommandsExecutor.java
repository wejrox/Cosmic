...
import extensions.CommandsExtension;
...
public class CommandsExecutor {
    ...
    private void registerLv0Commands() {
        ...
        CommandsExtension.lv0Commands.forEach(this::addCommand);
    ...
    private void registerLv1Commands() {
        ...
        CommandsExtension.lv1Commands.forEach((name, command) -> addCommand(name, 1, command));
    ...
    private void registerLv2Commands() {
        ...
        CommandsExtension.lv2Commands.forEach((name, command) -> addCommand(name, 2, command));
    ...
    private void registerLv3Commands() {
        ...
        CommandsExtension.lv3Commands.forEach((name, command) -> addCommand(name, 3, command));
    ...
    private void registerLv4Commands() {
        ...
        CommandsExtension.lv4Commands.forEach((name, command) -> addCommand(name, 4, command));
    ...
    private void registerLv5Commands() {
        ...
        CommandsExtension.lv5Commands.forEach((name, command) -> addCommand(name, 5, command));
    ...
    private void registerLv6Commands() {
        ...
        CommandsExtension.lv6Commands.forEach((name, command) -> addCommand(name, 6, command));
